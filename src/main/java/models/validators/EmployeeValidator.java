...
public class EmployeeValidator {
     ...
     * @param codeDuplicateCheckFlag 社員番号の重複チェックを実装するかどうか（実装する：true, 実装しない：false）
     * @param passwordCheckerFlag パスワードの入力チェックを実施するかどうか（実装する：true, 実装しない：false）
     * @return エラーのリスト
     */
